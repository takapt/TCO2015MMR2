    ...
    class DrawerPanel extends JPanel {
        public void paint(Graphics g) {
            synchronized (world.worldLock) {
                ...
                int yy = 225 + world.baseHealth.length*20;
                yy += 20;

                g2.drawString("Creep Money = " + world.tc.creepType.money, horPos, yy);
                yy += 15;
                g2.drawString("Creep hp = " + world.tc.creepType.health, horPos, yy);
                yy += 20;


                int xx = horPos + 160;
                yy = 15;
                for (int ttype = 0; ttype < world.tc.towerTypeCnt; ++ttype) {
                    g.setColor(new Color(0,128,0));
                    g.fillRect(xx, yy - 10, 10, 10);
